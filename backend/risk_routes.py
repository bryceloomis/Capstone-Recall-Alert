...
async def scan_barcode_with_risk(
    ...
    **Primary barcode-scan endpoint.**
    ...
    #    Recall notifications use the LLM summary when available.
    #    Allergen and diet notifications are always deterministic.
    recall_summary = recall_info.get("summary") if recall_info else None
    notifications = _build_notifications(report, recall_summary=recall_summary)
...
def _build_notifications(report, recall_summary: Optional[dict] = None) -> list[dict]:
    """
